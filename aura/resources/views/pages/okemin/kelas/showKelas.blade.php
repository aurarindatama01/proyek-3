    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <a class="btn btn-primary float-right mt-2" href="{{ url('/Okemin/Kelas/Create')}}" role="button" style="background-color: darkblue;">Tambah Kelas</a>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <tbody>
                      @foreach($kelas as $k )
                        <tr>
                            ...
                            <td>{{ $k->deskripsi }}</td>
                            <td>
                                <a type="button" class="btn btn-block bg-gradient btn-xs" style="background-color: darkblue; color:white;"  href="/Okemin/Kelas/Edit/{{ $k->id }}" >Edit</a>
