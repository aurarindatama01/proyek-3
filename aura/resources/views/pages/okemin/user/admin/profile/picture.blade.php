        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Photo Profil</li>
                </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="widget-user-image">
                        @if($admin->avatar)
                            <img class="img-circle mx-auto d-block" width="200px"  src="/storage/avatars/{{ $admin->avatar }}" alt="User Avatar">
                        @else
                            <img class="img-circle mx-auto d-block" width="200px"  src="{{ asset('/storage/avatars/defaultAvatar.png') }}" alt="User Avatar">
                        @endif
                    </div>

                <form role="form" action="/Okemin/User/Admin/Profile/Picture/Send/{{ $admin->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label>{{$admin->name}}'s Photo</label>
                        <br>
