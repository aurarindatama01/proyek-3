...
@section('title', 'Admin - Admin Profile Page Manager')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Admin Profile Page Manager</h1>
                    </div>
                <div class="col-sm-6">
                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                      <div class="text-center">
                            @if($admin->avatar)
                                <img class="profile-user-img img-fluid img-circle" src="/storage/avatars/{{ $admin->avatar }}" alt="User profile picture">
                            @else
                      ...
                      <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                            <b>Ganti Photo Profile User Ini?</b> <a href="/Okemin/User/Admin/Profile/Picture/{{ $admin->id }}" style="color: darkblue">Klik ini!</a>
                        </li>
                      </ul>
                    </div>
                    <!-- /.card-body -->
                    ...
                    <div class="card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" method="post" action="/Okemin/User/Admin/Profile/Send/{{ $admin->id }}">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="name" type="name" class="form-control" placeholder="Name" value="{{ $admin->name }}">
                                            @if($errors->has('name'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="username" type="text" class="form-control" placeholder="Username" value="{{ $admin->username }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="email" type="email" class="form-control" placeholder="E-mail" value="{{ $admin->email }}">
                                            @if($errors->has('email'))
                                                <div class="text-danger">
                                                    {{ $errors->first('email')}}
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="no_telp" type="text" class="form-control" placeholder="No. Telp" value="{{ $admin->no_telp }}">
                            ...
                            <div class="tab-pane" id="password">
                                ...
                                <!-- End of Success And Fail/Error Alert -->
                                <form class="form-horizontal" method="post" action="/Okemin/User/Admin/Profile/changePassword/{{ $admin->id }}">
                                    @csrf
                                    {{ method_field('POST') }}
                                    <div class="form-group row">
