    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <a class="btn btn-primary float-right mt-2" href="{{ url('/Okemin/User/Admin/Create')}}" role="button" style="background-color: darkblue;">Tambah Admin</a>
            </div>
                    ...
                    <tbody>
                      @foreach($admin as $a )
                        <tr>
                            ...
                            <td>{{ $a->email }}</td>
                            <td>
                                <a type="button" class="btn btn-block bg-gradient btn-xs" href="/Okemin/User/Admin/Profile/{{ $a->id }}" style="background-color: darkblue; color:white;">Edit Profile</a>
