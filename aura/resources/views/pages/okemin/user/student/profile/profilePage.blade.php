                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                      ...
                      <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                            <b>Ganti Photo Profile User Ini?</b> <a href="/Okemin/User/Student/Profile/Picture/{{ $student->id }}" style="color: darkblue">Klik ini!</a>
                        </li>
                      </ul>
                    </div>
                    <!-- /.card-body -->
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" method="post" action="/Okemin/User/Student/Profile/Send/{{ $student->id }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="tgl_lahir" type="date" class="form-control" placeholder="Tanggal Lahir, misal: 05" value="{{ $student->tgl_lahir }}">
